...
def generate_managers():
    with open('managers.csv', 'w') as f:
        f.write('id;surname;name;patronymic;citizenship;date_of_birth\n')
        for id in range(1, 1001):
            ...
            f.write(f'{id};{surname};{name};{patronymic};{citizenship};{date_of_birth}\n')

def generate_brands():
    with open('brands.csv', 'w') as f:
        f.write('id;name_company;country;date_of_create;id_manager\n')
        ...
        for id in range(1, 1001):
            ...
            count -= 1
            f.write(f'{id};{name_company};{country};{date_of_create};{id_manager}\n')

def generate_shops():
    with open('shops.csv', 'w') as f:
        f.write('id;name;specialization;number_of_employees;profit;id_sc\n')
        ...
        for id in range(1, 1001):
            ...
            f.write(f'{id};{name};{specialization};{number_of_employees};{profit};{id_sc}\n')

def generate_sc():
    with open('sc.csv', 'w') as f:
        f.write('id;name;address;number_of_floors;number_of_shops\n')
        ...
        for id in range(1, 1001):
            ...
            f.write(f'{id};{name};{address};{number_of_floors};{number_of_shops}\n')

def generate_owners_sc():
    with open('owners_sc.csv', 'w') as f:
        f.write('id;surname;name;patronymic;citizenship;date_of_birth;id_sc\n')
        ...
        for id in range(1, 1001):
            ...
            id_sc = r.randint(1, 1000)
            citizenship = fake.country()
            f.write(f'{id};{surname};{name};{patronymic};{citizenship};{date_of_birth};{id_sc}\n')
